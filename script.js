...
async function main() {
    const cities = ["paris", "newyork", "saopaulo", "barcelona", "atlanta", "buffalo", "bangalore", "munich", "coloradosprings", "london", "bognorregis", "tijuana", "AlphenaandenRijn", "bergen", "phoenix", "portland", "sanantonio", "washingtondc",  "sanfrancisco", "manizales", "saltlakecity", "toronto", "dallas", "charlotte", "sacramento", "pune", "eindhoven", "cambridge"]
