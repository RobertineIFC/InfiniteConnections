...
async function main() {
    const cities = ["paris", "newyork", "saopaulo", "barcelona", "atlanta", "buffalo", "london", "bognorregis", "tijuana", "rotterdam", "bergen", "phoenix", "portland", "sanantonio", "washingtondc",  "sanfrancisco", "manizales", "saltlakecity", "toronto", "dallas", "charlotte", "sacramento", "pune", "eindhoven", "cambridge"]
