...
async function main() {
    const cities = ["paris", "newyork", "saopaulo", "barcelona", "buffalo", "london", "rotterdam", "bergen", "phoenix", "sanantonio", "washingtondc",  "sanfrancisco", "manizales", "saltlakecity", "toronto", "dallas", "charlotte", "sacramento", "pune", "eindhoven", "cambridge"]
